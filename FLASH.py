...
def create_random_key():
    key = "SAHIL-SHAH-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./raazz {target} {port} {attack_time} 1200"  # ✅ Correct variable name
